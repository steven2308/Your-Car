...
urlpatterns = patterns('YourCar.alquiler.views',
    ...
    url(r'^vehiculos/(pag/(?P<pagina>\d{1,5})/)?$', 'verVehiculosControl', name='vistaVehiculos'),
    ...
    url(r'^alquiler/modificar/$', 'modificarDatosAlquilerControl', name='vistamodificarDatosAlquiler'),
    url(r'^alquiler/cierre/$', 'cierreDatosAlquilerControl', name='vistaCierreDatosAlquiler'),
    url(r'^alquiler/checklist/$', 'checklistVehiculoControl', name='vistaChecklistVehiculo'),
    ...
    url(r'^proveedores/(pag/(?P<pagina>\d{1,5})/)?$', 'proveedoresControl', name='vistaProveedor'),
    url(r'^proveedores/detalles/(?P<idProveedor>[0-9]{1,9})/$$', 'detallesProveedorControl', name='vistaDetallesProveedor'),
